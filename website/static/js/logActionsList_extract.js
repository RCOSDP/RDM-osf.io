...
var admin_contributor_added = _('The Integrated Admin added ${contributors} as contributor(s) to ${node}');
...
var mapcore_group_added = _('${user} added group ${mapcore_groups} to ${node}');
var mapcore_group_removed = _('${user} removed group ${mapcore_groups} from ${node}');
var mapcore_group_permission_updated = _('${user} updated group permissions on ${node}');
var mapcore_group_reordered = _('${user} reordered groups for ${node}');
var made_mapcore_group_visible = _('${user} made group ${mapcore_groups} visible on ${node}');
var made_mapcore_group_invisible = _('${user} made group ${mapcore_groups} invisible on ${node}');
...
var file_downloaded = _('${user} downloaded file ${path} from ${node}');
var folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from ${node}');
...
var osf_storage_file_downloaded = _('${user} downloaded file ${path} from ${storage_name} in ${node}');
var osf_storage_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from ${storage_name} in ${node}');
...
var box_file_downloaded = _('${user} downloaded file ${path} from Box in ${node}');
var box_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Box in ${node}');
...
var dataverse_file_downloaded = _('${user} downloaded file ${filename} from Dataverse dataset ${dataset} in ${node}');
var dataverse_folder_downloaded_zip = _('${user} downloaded folder ${filename} as a zip from Dataverse dataset ${dataset} in ${node}');
...
var dropbox_file_downloaded = _('${user} downloaded file ${path} from Dropbox in ${node}');
var dropbox_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Dropbox in ${node}');
...
var figshare_file_downloaded = _('${user} downloaded file ${path} from figshare in ${node}');
var figshare_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from figshare in ${node}');
...
var github_file_downloaded = _('${user} downloaded file ${path} from GitHub repo ${repo} in ${node}');
var github_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from GitHub repo ${repo} in ${node}');
...
var gitlab_file_downloaded = _('${user} downloaded file ${path} from GitLab repo ${gitlab_repo} in ${node}');
var gitlab_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from GitLab repo ${gitlab_repo} in ${node}');
...
var owncloud_file_downloaded = _('${user} downloaded file ${path} from ownCloud in ${node}');
var owncloud_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from ownCloud in ${node}');
...
var onedrive_file_downloaded = _('${user} downloaded file ${path} from Microsoft OneDrive in ${node}');
var onedrive_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Microsoft OneDrive in ${node}');
...
var s3_file_downloaded = _('${user} downloaded file ${path} from Amazon S3 bucket ${bucket} in ${node}');
var s3_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Amazon S3 bucket ${bucket} in ${node}');
...
var googledrive_file_downloaded = _('${user} downloaded file ${googledrive_path} from Google Drive in ${node}');
var googledrive_folder_downloaded_zip = _('${user} downloaded folder ${googledrive_path} as a zip from Google Drive in ${node}');
...
var bitbucket_file_downloaded = _('${user} downloaded file ${path} from Bitbucket repo ${bitbucket_repo} in ${node}');
var bitbucket_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Bitbucket repo ${bitbucket_repo} in ${node}');
...
var swift_file_downloaded = _('${user} downloaded file ${path} from Swift container ${bucket} in ${node}');
var swift_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Swift container ${bucket} in ${node}');
...
var azureblobstorage_file_downloaded = _('${user} downloaded file ${path} from Azure Blob Storage container ${bucket} in ${node}');
var azureblobstorage_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Azure Blob Storage container ${bucket} in ${node}');
...
var weko_file_downloaded = _('${user} downloaded draft file ${filename} from JAIRO Cloud index ${dataset} in ${node}');
var weko_folder_downloaded_zip = _('${user} downloaded folder ${filename} as a zip from JAIRO Cloud index ${dataset} in ${node}');
...
var s3compat_file_downloaded = _('${user} downloaded file ${path} from S3 Compatible Storage bucket ${bucket} in ${node}');
var s3compat_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from S3 Compatible Storage bucket ${bucket} in ${node}');
...
var s3compatsigv4_file_downloaded = _('${user} downloaded file ${path} from S3 Compatible Storage (SigV4) bucket ${bucket} in ${node}');
var s3compatsigv4_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from S3 Compatible Storage (SigV4) bucket ${bucket} in ${node}');
...
var s3compatinstitutions_file_downloaded = _('${user} downloaded file ${path} from S3 Compatible Storage for Institutions in ${node}');
var s3compatinstitutions_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from S3 Compatible Storage for Institutions in ${node}');
...
var s3compatb3_file_downloaded = _('${user} downloaded file ${path} from Oracle Cloud Infrastructure Object Storage bucket ${bucket} in ${node}');
var s3compatb3_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Oracle Cloud Infrastructure Object Storage bucket ${bucket} in ${node}');
...
var ociinstitutions_file_downloaded = _('${user} downloaded file ${path} from Oracle Cloud Infrastructure for Institutions in ${node}');
var ociinstitutions_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Oracle Cloud Infrastructure for Institutions in ${node}');
...
var nextcloud_file_downloaded = _('${user} downloaded file ${path} from Nextcloud in ${node}');
var nextcloud_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Nextcloud in ${node}');
...
var nextcloudinstitutions_file_downloaded = _('${user} downloaded file ${path} from Nextcloud (for Institutions) in ${node}');
var nextcloudinstitutions_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Nextcloud (for Institutions) in ${node}');
...
var iqbrims_file_downloaded = _('${user} downloaded file ${iqbrims_path} from IQB-RIMS in ${node}');
var iqbrims_folder_downloaded_zip = _('${user} downloaded folder ${iqbrims_path} as a zip from IQB-RIMS in ${node}');
...
var dropboxbusiness_file_downloaded = _('${user} downloaded file ${path} from Dropbox Business in ${node}');
var dropboxbusiness_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from Dropbox Business in ${node}');
...
var onedrivebusiness_file_downloaded = _('${user} downloaded file ${path} from the OneDrive team folder ${folder} in ${node}');
var onedrivebusiness_folder_downloaded_zip = _('${user} downloaded folder ${path} as a zip from the OneDrive team folder ${folder} in ${node}');
