...
var workflow_file_added = _('${user} created a ${filename} workflow in ${node}');
var workflow_file_updated = _('${user} updated a ${filename} workflow in ${node}');
var workflow_file_deleted = _('${user} deleted a ${filename} workflow in ${node}');
