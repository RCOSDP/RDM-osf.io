...
class TestWEKOSchema(OsfTestCase):
    ...
    def test_write_csv_minimal(self):
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186331708[0].subitem_title',
                '',
                '',
                '',
                'ENGLISH TITLE',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186331708[0].subitem_title_language',
                '',
                '',
                '',
                'en',
    ...
    def test_write_csv_full(self):
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186476635.subitem_access_right',
                '',
                '',
                '',
                'restricted access',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[0].contributorNames[0].nameType',
                '',
                '',
                '',
                'Organizational',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[0].contributorNames[1].nameType',
                '',
                '',
                '',
                'Organizational',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].contributorNames[0].contributorName',
                '',
                '',
                '',
                'Joho, Hanako',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].contributorNames[0].lang',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].contributorType',
                '',
                '',
                '',
                'DataManager',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].familyNames[0].familyName',
                '',
                '',
                '',
                'Joho',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].familyNames[0].lang',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].givenNames[0].givenName',
                '',
                '',
                '',
                'Hanako',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].givenNames[0].lang',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].contributorNames[1].contributorName',
                '',
                '',
                '',
                '情報, 花子',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].contributorNames[1].lang',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].familyNames[1].familyName',
                '',
                '',
                '',
                '情報',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].familyNames[1].lang',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].givenNames[1].givenName',
                '',
                '',
                '',
                '花子',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].givenNames[1].lang',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].nameIdentifiers[0].nameIdentifierScheme',
                '',
                '',
                '',
                'e-Rad_Researcher',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[1].nameIdentifiers[0].nameIdentifierURI',
                '',
                '',
                '',
                '11111',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[0].subitem_rights',
                '',
                '',
                '',
                'Test for license',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[0].subitem_rights_language',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[1].subitem_rights',
                '',
                '',
                '',
                'ライセンスのテスト',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[1].subitem_rights_language',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[2].subitem_rights',
                '',
                '',
                '',
                '無償',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[2].subitem_rights_language',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[3].subitem_rights',
                '',
                '',
                '',
                'free',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[3].subitem_rights_language',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[4].subitem_rights',
                '',
                '',
                '',
                'CC0 1.0 Universal',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186499011[4].subitem_rights_language',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186609386[0].subitem_subject',
                '',
                '',
                '',
                'Life Science',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186609386[0].subitem_subject_language',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186609386[0].subitem_subject_scheme',
                '',
                '',
                '',
                'e-Rad_field',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186609386[1].subitem_subject',
                '',
                '',
                '',
                'ライフサイエンス',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186609386[1].subitem_subject_language',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186609386[1].subitem_subject_scheme',
                '',
                '',
                '',
                'e-Rad_field',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].contributorNames[0].contributorName',
                '',
                '',
                '',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].contributorNames[0].lang',
                '',
                '',
                '',
                'en',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].contributorType',
                '',
                '',
                '',
                'HostingInstitution',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].nameIdentifiers[0].nameIdentifierScheme',
                '',
                '',
                '',
                'ROR',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].nameIdentifiers[0].nameIdentifierURI',
                '',
                '',
                '',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].contributorNames[1].contributorName',
                '',
                '',
                '',
                '国立情報学研究所',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617349709064[2].contributorNames[1].lang',
                '',
                '',
                '',
                'ja',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186331708[1].subitem_title',
                '',
                '',
                '',
                'テストデータ',
        ...
        assert_equal(
            props.pop(),
            [
                '.metadata.item_1617186331708[1].subitem_title_language',
                '',
                '',
                '',
                'ja',
