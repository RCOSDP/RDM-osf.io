...
api_routes = {
    'rules': [
        ...
        Rule(
            ...
            'put',
            views.metadata_update_config,
            json_renderer,
        ),
        Rule(
            [
                '/project/<pid>/{}/erad/candidates'.format(SHORT_NAME),
                '/project/<pid>/node/<nid>/{}/erad/candidates'.format(
                    SHORT_NAME
                ),
            ],
            'get',
            views.metadata_get_erad_candidates,
            json_renderer,
        ),
        Rule(
            [
        ...
        Rule(
            ...
            'get',
            views.metadata_get_schemas,
            json_renderer,
        ),
        Rule(
            [
                '/project/<pid>/{}/files/<path:filepath>'.format(SHORT_NAME),
                '/project/<pid>/node/<nid>/{}/files/<path:filepath>'.format(
                    SHORT_NAME
                ),
            ],
            'get',
            views.metadata_get_file,
            json_renderer,
        ),
        Rule(
            [
        ...
        Rule(
            ...
            'delete',
            views.metadata_delete_file,
            json_renderer,
        ),
        Rule(
            [
                '/project/<pid>/{}/hashes/<path:filepath>'.format(SHORT_NAME),
                '/project/<pid>/node/<nid>/{}/hashes/<path:filepath>'.format(
                    SHORT_NAME
                ),
            ],
            'patch',
            views.metadata_set_file_hash,
            json_renderer,
        ),
        Rule(
            [
                '/project/<pid>/{}/draft_registrations/<did>/files/<mnode>/<path:filepath>'.format(
                    SHORT_NAME
                ),
                '/project/<pid>/node/<nid>/{}/draft_registrations/<did>/files/<mnode>/<path:filepath>'.format(
                    SHORT_NAME
                ),
            ],
            'put',
            views.metadata_set_file_to_drafts,
            json_renderer,
        ),
        Rule(
            [
            ...
            'delete',
            views.metadata_delete_file_from_drafts,
            json_renderer,
        ),
        Rule(
            [
        ...
        Rule(
            ...
            'put',
            views.metadata_export_project,
            json_renderer,
        ),
        Rule(
            [
                '/project/<pid>/{}/packages/tasks/<taskid>/'.format(
                    SHORT_NAME
                ),
                '/project/<pid>/node/<nid>/{}/packages/tasks/<taskid>/'.format(
                    SHORT_NAME
                ),
            ],
            'get',
    ...
    'rules': [
        ...
        Rule(
            [
                ...
                '/<pid>/node/<nid>/{}/draft_registrations/<did>/csv'.format(
                    SHORT_NAME
                ),
            ],
            'get',
        ...
        Rule(
            [
                ...
                '/<pid>/node/<nid>/{}/registrations/<rid>/csv'.format(
                    SHORT_NAME
                ),
            ],
            'get',
