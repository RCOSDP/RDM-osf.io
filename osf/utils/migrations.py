...
def create_schema_block(state, schema_id, block_type, display_text='', required=False, help_text='',
        ...
        message_required_if=None, enabled_if=None, suggestion=None, auto_value=False, auto_date=False, auto_title=False, hide_projectmetadata=False, get_retrieval_title='', get_retrieval_date='', concealment_page_navigator=False, multi_language=False, get_retrieval_version='', get_edit=False, sentence=False, required_all_check=None, row_addition_caption=''):
    """
    ...
    additional = {
        ...
        'get_retrieval_title': get_retrieval_title,
        'required_all_check': required_all_check,
        'get_retrieval_date': get_retrieval_date,
        'concealment_page_navigator': concealment_page_navigator,
        'multi_language': multi_language,
        'get_retrieval_version': get_retrieval_version,
        'get_edit': get_edit,
        'sentence': sentence,
...
def create_schema_blocks_for_question(state, rs, question, sub=False):
    ...
    if properties:
        ...
        create_schema_block(
            ...
            get_retrieval_title=question.get('get_retrieval_title', ''),
            get_retrieval_date=question.get('get_retrieval_date', ''),
            required_all_check=question.get('required_all_check', ''),
            get_retrieval_version=question.get('get_retrieval_version', ''),
            get_edit=question.get('get_edit', False),
