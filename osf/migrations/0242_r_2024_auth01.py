...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('osf', '0241_ensure_schema_mappings.py'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aal', models.IntegerField(blank=True, choices=[(0, 'NULL'), (1, 'AAL1'), (2, 'AAL2')], null=True)),
                ('ial', models.IntegerField(blank=True, choices=[(0, 'NULL'), (1, 'IAL1'), (2, 'IAL2')], null=True)),
                (
                    'is_mfa',
                    models.BooleanField(
